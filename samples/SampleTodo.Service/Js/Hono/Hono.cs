...
public class Hono
{
    ...
    [Name("delete")]
    public void Delete(string path, Func<IHonoContext, IHonoContext> handler) =>
        throw new NotSupportedException();
    ...
    [Name("post")]
    public void Post(string path, Func<IHonoContext, Task<IHonoContext>> handler) =>
        throw new NotSupportedException();

    [Name("patch")]
    public void Patch(string path, Func<IHonoContext, Task<IHonoContext>> handler) =>
        throw new NotSupportedException();

    [Name("put")]
    public void Put(string path, Func<IHonoContext, Task<IHonoContext>> handler) =>
        throw new NotSupportedException();
}
