...
public static class BclMapper
{
    ...
    )
    {
        ...
        // (string.Length is now handled declaratively via Metano/Runtime/Strings.cs.)

        // List/Queue/Stack collection-family Count → length and Dictionary/HashSet
        // Count → size are now handled declaratively via Metano/Runtime/Lists.cs,
        // Queues.cs, Stacks.cs, Dictionaries.cs and Sets.cs.

        // Task.CompletedTask, DateTimeOffset.UtcNow and DateOnly.DayNumber are now
        // handled declaratively via Metano/Runtime/Tasks.cs and Temporal.cs. The
    ...
    )
    {
        ...
        // Metano/Runtime/Queues.cs and Metano/Runtime/Stacks.cs.

        // LINQ extension methods are now handled declaratively via Metano/Runtime/Linq.cs.
        ...
        // declaratively via Metano/Runtime/Dictionaries.cs and Metano/Runtime/Sets.cs.
        ...
        // Metano/Runtime/Enums.cs (the latter uses the $T0 placeholder for the
        // generic method type-argument name).

        // Console.WriteLine, Guid.NewGuid, Guid.ToString(format), Task.FromResult are now
        // handled declaratively via Metano/Runtime/Console.cs, Guid.cs and Tasks.cs.
    ...
    // gone now — the equivalent logic lives in Metano/Runtime/*.cs declarations and
