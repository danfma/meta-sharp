...
//
// Every LINQ call lowers to a method on the @meta-sharp/runtime Enumerable wrapper. The
...
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.Where),             WrapReceiver = "Enumerable.from", JsMethod = "where")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.Select),            WrapReceiver = "Enumerable.from", JsMethod = "select")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.SelectMany),        WrapReceiver = "Enumerable.from", JsMethod = "selectMany")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.OrderBy),           WrapReceiver = "Enumerable.from", JsMethod = "orderBy")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.OrderByDescending), WrapReceiver = "Enumerable.from", JsMethod = "orderByDescending")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.ThenBy),            WrapReceiver = "Enumerable.from", JsMethod = "thenBy")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.ThenByDescending),  WrapReceiver = "Enumerable.from", JsMethod = "thenByDescending")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.Take),              WrapReceiver = "Enumerable.from", JsMethod = "take")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.Skip),              WrapReceiver = "Enumerable.from", JsMethod = "skip")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.Distinct),          WrapReceiver = "Enumerable.from", JsMethod = "distinct")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.GroupBy),           WrapReceiver = "Enumerable.from", JsMethod = "groupBy")]
...
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.Prepend),           WrapReceiver = "Enumerable.from", JsMethod = "prepend")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.Union),             WrapReceiver = "Enumerable.from", JsMethod = "union")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.Intersect),         WrapReceiver = "Enumerable.from", JsMethod = "intersect")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.Except),            WrapReceiver = "Enumerable.from", JsMethod = "except")]
...
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.LastOrDefault),  WrapReceiver = "Enumerable.from", JsMethod = "lastOrDefault")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.Single),         WrapReceiver = "Enumerable.from", JsMethod = "single")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.SingleOrDefault),WrapReceiver = "Enumerable.from", JsMethod = "singleOrDefault")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.Any),            WrapReceiver = "Enumerable.from", JsMethod = "any")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.All),            WrapReceiver = "Enumerable.from", JsMethod = "all")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.Count),          WrapReceiver = "Enumerable.from", JsMethod = "count")]
[assembly: MapMethod(typeof(Enumerable), nameof(Enumerable.Sum),            WrapReceiver = "Enumerable.from", JsMethod = "sum")]
